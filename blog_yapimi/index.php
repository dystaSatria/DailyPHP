    ...
    <div class="row">
        ...
        if (mysqli_num_rows($artikel_result) > 0) {
            while ($row = mysqli_fetch_assoc($artikel_result)) {
                ...
                echo "<p class='text-muted'>Tanggal: " . $row['tanggal'] . "</p>";
                echo "<p class='text-muted'>Kategori: " . $row['kategori'] . "</p>";
                echo "<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#artikelModal" . $row['id'] . "'>Baca Selengkapnya</button>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
                ...
                echo "<h5 class='modal-title' id='artikelModalLabel" . $row['id'] . "'>" . $row['judul'] . "</h5>";
